...
## 📍프로젝트 소개
현재 위치를 바탕으로 날씨를 알려주는 리액트 기반의 날씨 앱 미니 프로젝트입니다. OpenWeatherMap API를 통해 현재 위치의 날씨 정보를 실시간으로 받아와 렌더링하며, 미리 설정된 주요 도시의 날씨도 확인할 수 있습니다.
...
<div>
	...
	<img src="https://img.shields.io/badge/API Call-E3695F?style=for-the-badge&logoColor=black"> 
</div>
